 ...
 *
 * This decorator applies validation and API documentation to the `updated` field of a question.
 ...
 * Example usage:
 * ```typescript
 * import { ApiQuestionUpdatedProperty } from './decorators';
 *
 ...
 *
 * Description:
 * - The `updated` property specifies the date and time when the question was last updated.
 *
 * Example value:
 ...
 */
export function ApiQuestionUpdatedProperty(): PropertyDecorator {
