 ...
 *
 * This decorator applies validation and API documentation to the question ID field.
 ...
 * Example usage:
 * ```typescript
 * import { ApiQuestionIdProperty } from './decorators';
 *
 ...
 */
export function ApiQuestionIdProperty(): PropertyDecorator {
